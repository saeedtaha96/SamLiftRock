...
public class DraftListInfoAllAdapter extends RecyclerView.Adapter<DraftListInfoAllAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_draft_list_info_all_rv, parent, false);
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(@NonNull View itemView) {
            super(itemView);
            techNum = itemView.findViewById(R.id.adapter_draft_info_all_rv_tech_num);
            productName = itemView.findViewById(R.id.adapter_draft_info_all_rv_product_name);
